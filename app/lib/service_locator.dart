...
import 'package:app/features/theme/data/repositories/theme_repository.dart';
...
void setupServiceLocator() {
  ...
  sl.registerLazySingleton<FlutterSecureStorage>(() =>
      const FlutterSecureStorage()); // Enregistrement loca de données sécurisé

  sl.registerLazySingleton<SharedPreferencesAsync>(
      () => SharedPreferencesAsync()); // Enregistrement local de données
